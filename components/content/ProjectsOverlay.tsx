      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full max-w-4xl bg-black/95 border-l-2 border-green-500 shadow-2xl z-50 overflow-y-auto font-mono"
            style={{
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 p-2 border border-green-500/50 hover:border-green-500 hover:bg-green-500/10 transition-all z-10 group"
            >
            ...
            <div className="absolute top-1/2 left-0 right-0 flex justify-between px-6 -translate-y-1/2 pointer-events-none z-10">
              <button
                ...
                className="p-3 border-2 border-green-500/50 hover:border-green-500 bg-black/80 hover:bg-green-500/20 transition-all pointer-events-auto disabled:opacity-30 disabled:cursor-not-allowed"
    ...
    {currentProject.links.demo && (
      ...
      >
        ...
        <span>LIVE_DEMO</span>
                ...
                <div className="mt-8 pt-4 border-t border-green-500/30 text-green-500/60 text-xs text-center tracking-widest">
